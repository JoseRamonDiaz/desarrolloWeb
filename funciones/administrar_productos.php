 ...
 if ( isset($_POST["btn_grabar"]) && $_POST["btn_grabar"] == "Guardar"){
  ...
  $cquery = "SELECT usuario FROM usuario";
   ...
   if ( !existeRegistro($cquery, $pconexion) ){
	   ...
	   $cquery .= " (nombre, apellido, direccion, usuario, contrasena, email, telefono, fax, empresa, cp, pais)";
	   $cquery .= " VALUES ('$cnombre', '$capellidos', '$cdireccion', '$cusuario', '$ccontrasena', '$cmail', '$ctelefono', '$cfax', '$cempresa', '$ccp', '$cpais' )";
